<template>
  ...
  >
    <NuxtImg
      :src="
        blok.image.filename ? blok.image.filename : '/img/team/placeholder.jpg'
      "
      :alt="blok.name"
      :placeholder="[30, 30]"
      provider="storyblok"
